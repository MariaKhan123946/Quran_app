...
import 'package:quran_app/app/data/models/SurahDetail.dart' as detail;
...
class DetailSurahView extends GetView<DetailSurahController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<detail.SurahDetail>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (Get.arguments != null && Get.arguments.containsKey("index_ayat")) {
                        ...
                        return AutoScrollTag(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 20.h),
                              Container(
                                padding: const EdgeInsets.only(right: 15, left: 15, bottom: 15).r,
                                child: Text(
                                  '${ayat.translation?.id}',
